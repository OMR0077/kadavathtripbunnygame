...
function init() {  
  ...
  const addBunny = () => {
    const name = bunnyNames[settings.bunnies.length % bunnyNames.length];
const bunny = {
...
nameTag.style.cssText = 'position: absolute; top: -20px; font-size: 0.75rem; color: #000; background: rgba(255,255,255,0.6); padding: 2px 6px; border-radius: 5px;';
bunny.el.appendChild(nameTag);
...
a.click();
    ...
    player.pause = true
    bunny.sad = false
    bunny.sprite.el.classList.add('happy');
